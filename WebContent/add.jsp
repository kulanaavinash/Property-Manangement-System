			...
			<div class="wrap">
				<form class="form" action="PropertyController" method="POST">
				  <div class="form-group">
			    	...
			    	<input type="text" name="powner" pattern="[a-zA-Z]+" class="form-control" id="inputadd" placeholder="Product Name" required/>   
			  	  </div>
			  	  <div class="form-group">
			    	<label class="labeladd" for="exampleInputPassword1">Category</label>
			    	<input type="text" name="pstatus"  pattern="[a-zA-Z]+" class="form-control" id="inputadd" placeholder="Category" required/>
			  	  </div>	
			  	  <div class="form-group">
			    	<label class="labeladd" for="exampleInputUser">Quantity</label>
			    	<input type="text" name="pprice" pattern="[0-9][0-9][0-9]" class="form-control" id="inputadd" placeholder="Quantity" required/>   
			  	  </div>	
			  	   <div class="form-group">
			    	<label class="labeladd" for="exampleInputUser">Tailorshop Name</label>
			    	<input type="text" name="paddress" pattern="[a-zA-Z]+" class="form-control" id="inputadd" placeholder="Tailorshop Name" required/>   
			  	  </div>		  	    			   	 
